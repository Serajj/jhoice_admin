...
<!-- Order Field -->
    ...
    <!-- Duration Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('duration', "Auto Cancel Booking after", ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
         <div id="duration-field" class="col-md-9">
            ...
            <div class="form-text text-muted">
                Enter Duration in hours. Example: 11:05 means 11 hours 05 minutes
            </div>
        </div>
    </div>
</div>
