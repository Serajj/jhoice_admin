...
@endcan
@can('categoryManage.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('categoryManage*') ? 'active' : '' }}" href="{!! route('categoryManage.index') !!}">@if($icons)
                <i class="nav-icon 	fas fa-th-list"></i>@endif<p>{{trans('lang.category_settings')}}</p></a>
    </li>
@endcan
...
@can('eServices.index')
    <li class="nav-item has-treeview {{ Request::is('eServices*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('eServiceReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('track')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('track*') ? 'active' : '' }}" href="track">@if($icons)
                            <i class="nav-icon fas fa-list"></i>@endif
                        <p>{{trans('lang.track_user_click')}}</p></a>
                </li>
            @endcan
...
@can('campaigns.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('campaigns*') ? 'active' : '' }}" href="{!! route('campaigns.index') !!}">@if($icons)
                <i class="nav-icon fas fa-bullhorn"></i>@endif<p>{{trans('lang.campaigns')}}</p></a>
    </li>
@endcan
@can('faqs.index')
...
@endcan
<li class="nav-item {{ Request::is('PostCategories*') || Request::is('Post*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('Post*') || Request::is('PostCategories*') ? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-address-card"></i>@endif
    ...
    <ul class="nav nav-treeview">
        ...
        @can('Posts.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('Post*') ? 'active' : '' }}" href="{!! route('Posts.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-life-ring"></i>@endif
...
<li class="nav-item {{ Request::is('ReferralCategories*') || Request::is('Referral*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('Referral*') || Request::is('ReferralCategories*') ? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-snowflake"></i>@endif
        <p>{{trans('Referral')}} <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        ...
        @can('Referrals.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('Referral*') ? 'active' : '' }}" href="{!! route('Referrals.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-life-ring"></i>@endif
