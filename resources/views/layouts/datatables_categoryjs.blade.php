...
<script type="text/javascript">
    function initICheck() {
        $('select').each(function (event) {
            ...
            if(typeId!=null)
                checkbox.val(typeId.typeId.type);
        ...
        $('select').click(function () {
            ...
            // if (typeId.typeId.type!=checkbox.val()) {
                url = "{{url('categoryManage/changeType')}}";
                $.ajax({
                method: "POST",
                url: url,
                data: {_token: "{{csrf_token()}}", id: typeId.typeId.id,type: checkbox.val()}
                })
                .done(function (msg) {
