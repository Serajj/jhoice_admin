        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!-- 'fixed_header Field' -->
                    ...
                    <!-- 'Auto Accept Providers Field' -->
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        {!! Form::label('auto_accept_provider', "Auto Accept Providers?",['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8 icheck-{{setting('theme_color')}}">
                            {!! Form::checkbox('auto_accept_provider', 1, setting('auto_accept_provider')) !!}
                            <label for="auto_accept_provider"></label>
                        </div>
                    </div>
