    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('e_provider.name', function ($booking) {
                return "<a data-toggle='tooltip' data-placement='left' title='id:".preg_replace('{}','',$booking->id)."Provider Id:".preg_replace('{}','',$booking->e_provider->id)."
					Name:".preg_replace('{}','',$booking->e_provider->name)."
					Description:".preg_replace('{}','',$booking->e_provider->description)."
					Available Rang:".preg_replace('{}','',$booking->e_provider->availability_range)."
					Available:".preg_replace('{}','',$booking->e_provider->available)."
					Featured:".preg_replace('{}','',$booking->e_provider->featured)."
					Type:".preg_replace('{}','',$booking->e_provider->e_provider_type_id )."
					Mobile Number:".preg_replace('{}','',$booking->e_provider->mobile_number)."
				Phone Number:".preg_replace('{}','',$booking->e_provider->phone_number)."
				
				' class='btn btn-link'>
             ". getLinksColumnByRouteName([$booking->e_provider], 'eProviders.edit', 'id', 'name'). "</a>";
            })
